...
public class RabbitDomainEventPublisher implements DomainEventPublisher {
    ...
    public void publish(String routingKey, Object payload) {
        ...
        try {
            ...
            // Application is already committed — do not fail the HTTP request if the broker is down.
            log.error("Failed to publish event key={} — start RabbitMQ (docker compose up -d)", routingKey, ex);
        }
    }
}
